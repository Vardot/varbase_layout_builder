...
module.exports = {
  ...
  entry: {
    ...
    'components/form--select': [
      './themes/claro10/scss/components/form--select.scss',
    ],
    ...
    'components/action-link': [
      './themes/claro10/scss/components/action-link.scss',
    ],
    'components/divider': ['./themes/claro10/scss/components/divider.scss'],
    'components/form--text': [
      './themes/claro10/scss/components/form--text.scss',
    ],
    'components/skip-link': ['./themes/claro10/scss/components/skip-link.scss'],
    'components/table--file-multiple-widget': [
      './themes/claro10/scss/components/table--file-multiple-widget.scss',
    ],
    'components/ajax-progress-module': [
      './themes/claro10/scss/components/ajax-progress-module.scss',
    ],
    'components/dropbutton': [
      './themes/claro10/scss/components/dropbutton.scss',
    ],
    'components/help': ['./themes/claro10/scss/components/help.scss'],
    'components/system-admin--admin-list': [
      './themes/claro10/scss/components/system-admin--admin-list.scss',
    ],
    'components/tableselect': [
      './themes/claro10/scss/components/tableselect.scss',
    ],
    'components/autocomplete-loading-module': [
      './themes/claro10/scss/components/autocomplete-loading-module.scss',
    ],
    'components/entity-meta': [
      './themes/claro10/scss/components/entity-meta.scss',
    ],
    'components/icon-link': ['./themes/claro10/scss/components/icon-link.scss'],
    'components/system-admin--links': [
      './themes/claro10/scss/components/system-admin--links.scss',
    ],
    'components/tablesort-indicator': [
      './themes/claro10/scss/components/tablesort-indicator.scss',
    ],
    'components/breadcrumb': [
      './themes/claro10/scss/components/breadcrumb.scss',
    ],
    'components/fieldset': ['./themes/claro10/scss/components/fieldset.scss'],
    'components/image-preview': [
      './themes/claro10/scss/components/image-preview.scss',
    ],
    'components/system-admin--modules': [
      './themes/claro10/scss/components/system-admin--modules.scss',
    ],
    ...
    'components/media-library.ui': [
      './themes/claro10/scss/components/media-library.ui.scss',
    ],
    'components/system-admin--panel': [
      './themes/claro10/scss/components/system-admin--panel.scss',
    ],
    ...
    'components/form--checkbox-radio': [
      './themes/claro10/scss/components/form--checkbox-radio.scss',
    ],
    'components/media': ['./themes/claro10/scss/components/media.scss'],
    'components/vertical-tabs': [
      './themes/claro10/scss/components/vertical-tabs.scss',
    ],
    'components/container-inline-module': [
      './themes/claro10/scss/components/container-inline-module.scss',
    ],
    'components/form--field-multiple': [
      './themes/claro10/scss/components/form--field-multiple.scss',
    ],
    'components/menus-and-lists': [
      './themes/claro10/scss/components/menus-and-lists.scss',
    ],
    'components/system-status-counter': [
      './themes/claro10/scss/components/system-status-counter.scss',
    ],
    'components/views-exposed-form': [
      './themes/claro10/scss/components/views-exposed-form.scss',
    ],
    'components/container-inline': [
      './themes/claro10/scss/components/container-inline.scss',
    ],
    'components/form--managed-file': [
      './themes/claro10/scss/components/form--managed-file.scss',
    ],
    'components/messages': ['./themes/claro10/scss/components/messages.scss'],
    'components/views_ui.admin': [
      './themes/claro10/scss/components/views_ui.admin.scss',
    ],
    'components/content-header': [
      './themes/claro10/scss/components/content-header.scss',
    ],
    'components/form--password-confirm': [
      './themes/claro10/scss/components/form--password-confirm.scss',
    ],
    ...
    'components/page-title': [
      './themes/claro10/scss/components/page-title.scss',
    ],
    // Layout
    ...
    'layout/system-admin--layout': [
      './themes/claro10/scss/layout/system-admin--layout.scss',
    ],
    // Theme
    'theme/bootstrap-styles.dark': [
      './themes/claro10/scss/theme/bootstrap-styles.dark.scss',
    ],
    ...
    'theme/vartheme-claro.theme.style': [
      './themes/claro10/scss/theme/vartheme-claro.theme.style.scss',
    ],
  },
  output: {
